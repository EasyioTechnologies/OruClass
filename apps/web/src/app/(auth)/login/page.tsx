  ...
  return (
    <div className="w-full max-w-lg mx-auto p-6 sm:p-12 relative z-10">
      ...
      <div className="space-y-3 sm:space-y-4">
        <Link
          href="/login/trainer"
          className="group relative flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-white rounded-2xl border-2 border-emerald-50 hover:border-emerald-500 hover:shadow-lg transition-all duration-300"
        >
          <div className="shrink-0 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-100/50 text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-colors duration-300">
            <Presentation className="w-5 h-5 sm:w-6 sm:h-6" strokeWidth={2} />
          </div>
          <div className="flex-1 min-w-0 pr-2 sm:pr-8">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 group-hover:text-emerald-700 transition-colors">I'm a Trainer</h2>
        ...
        <Link
          ...
          className="group relative flex items-start gap-3 sm:gap-4 p-4 sm:p-6 bg-white rounded-2xl border-2 border-slate-100 hover:border-slate-400 hover:shadow-lg transition-all duration-300"
        >
          <div className="shrink-0 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-slate-100 text-slate-600 group-hover:bg-slate-600 group-hover:text-white transition-colors duration-300">
            <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6" strokeWidth={2} />
          </div>
          <div className="flex-1 min-w-0 pr-2 sm:pr-8">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 group-hover:text-slate-800 transition-colors">I'm a Participant</h2>
